...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/27 15:40:55 by afarachi          #+#    #+#             */
/*   Updated: 2024/09/27 15:40:55 by afarachi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	dda_algorithm(t_cub3d_data *data, t_ray_cast *ray)
{
	char	map_value;
...
static void	compute_raycasting_values_utils(t_cub3d_data *data, t_ray_cast *ray)
{
	if (ray->ray_dir_x < 0)
	{
		ray->step_x = -1;
...
static void	compute_raycasting_values(t_cub3d_data *data, t_ray_cast *ray)
{
	float	fov_radian;
...
static void	get_wall_dist(t_cub3d_data *data, t_ray_cast *ray)
{
	if (ray->side == 0)
